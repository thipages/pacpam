export default {
  ...
  "events": {
    ...
    "PEER_CREATION_ERROR": "Échec de la création de la connexion P2P (WebRTC indisponible).",
    "SIGNALING_ERROR": "Une erreur du serveur de signalisation empêche la communication.",
    "CONNECTION_ERROR": "Une erreur du canal de données WebRTC empêche la communication.",
  ...
  "errors": {
    ...
    "PEER_CREATION_ERROR": "Impossible de créer la connexion P2P.",
    "SIGNALING_ERROR": "Erreur du serveur de signalisation.",
    "CONNECTION_ERROR": "Erreur de connexion P2P.",
